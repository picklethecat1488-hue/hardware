...
class ExhaustManifoldsConfig(BaseModel):
    ...
    diagram_options: DiagramOptions = Field(
        default_factory=lambda: DiagramOptions(view_from="rear", show_axes=True),
    ...
    diagram_label_dist: int = Field(default=30, description="Distance of the labels from the parts in the diagram")
