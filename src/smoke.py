...
class TestSmoke:
    ...
    @pytest.fixture
    def ocp_port(self):
        """Start a dummy server to accept ocp_vscode.show() calls."""
    ...
    def run_command(self, args: list[str], extra_env: dict = None):
    ...
    def test_view_commands(self, ocp_port):
        """Verify view.py commands execute correctly."""
        env = {"OCP_PORT": str(ocp_port)}
