...
> 5. **Drive Hub Standoff Ring**: The drive hub features an integrated annular standoff ring around the shaft hole on the bottom surface, acting as a built-in thrust washer that elevates the hub face 0.5 mm to minimize rotational contact area and friction against the motor housing.
> 6. **Rubber Feet Depressions**: The underside of the bottom cover contains 4 symmetrically spaced circular recesses (pitch radius 78 mm, depth 1.0 mm, diameter 11.0 mm) to firmly seat self-adhesive anti-slip silicone/rubber bumper feet and prevent tabletop sliding.
