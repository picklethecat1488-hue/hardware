...
- **exhaust\_manifolds\_v3\_driver.stl** \- the fully assembled driver manifold.  
- **exhaust\_manifolds\_v3\_driver\_left.stl** \- the left side of the driver manifold.  
- **exhaust\_manifolds\_v3\_driver\_right.stl** \- the right side of the driver manifold.  
- **exhaust\_manifolds\_v3\_passenger.stl** \- the fully assembled passenger manifold.  
- **exhaust\_manifolds\_v3\_passenger\_left.stl** \- the left side of the passenger manifold.  
- **exhaust\_manifolds\_v3\_passenger\_right.stl** \- the right side of the passenger manifold.
...
Run jupyter lab, then open the notebook. I use the lab GUI to modify the notebook. Prior to committing, you should run nbstripout prior to pushing any changes to make sure the notebook is free of artifacts.